...
public class DepartmentService : IDepartmentService
{
    ...
    public async Task<ApiResponse<IReadOnlyList<DepartmentDto>>> GetAllDepartmentsAsync()
    {
        ...
        var departments = await _unitOfWork.DepartmentRepository.ListAsync(spec);
    ...
    public async Task<ApiResponse<DepartmentDto>> GetDepartmentByIdAsync(int id)
    {
        ...
        var department = await _unitOfWork.DepartmentRepository.GetEntityWithSpec(spec);
        if (department == null)
        {
    ...
    public async Task<ApiResponse<DepartmentDto>> CreateDepartmentAsync(CreateDepartmentDto createDto)
    {
        ...
        var existing = await _unitOfWork.DepartmentRepository.GetEntityWithSpec(existingSpec);
        if (existing != null)
        {
